...
class TestMotionEventModels:
    ...
    @pytest.mark.parametrize("model_class,valid_data", [
        (MotionEventCreate, {"confidence": 0.85, "duration": 2.3, "description": "Test"}),
        (MotionEventCreate, {"confidence": 0.7, "duration": 1.5}),  # Minimal fields
        (MotionEvent, {
            "id": 1, "timestamp": "2025-08-10T10:30:00Z", 
    ...
    @pytest.mark.parametrize("model_class,missing_field,base_data", [
        (MotionEventCreate, "confidence", {"duration": 2.0}),
        (MotionEventCreate, "duration", {"confidence": 0.8}),
        (MotionEvent, "id", {"timestamp": "2025-08-10T10:30:00Z", "confidence": 0.85, "duration": 2.3, "description": "Test"}),
        (MotionEvent, "timestamp", {"id": 1, "confidence": 0.85, "duration": 2.3, "description": "Test"}),
    ])
    ...
    @pytest.mark.parametrize("model_class,field,invalid_value,base_data", [
        (MotionEventCreate, "confidence", "invalid", {"duration": 2.0}),
        (MotionEventCreate, "duration", "invalid", {"confidence": 0.8}),
        (MotionEventCreate, "description", 123, {"confidence": 0.8, "duration": 2.0}),
        (MotionEvent, "id", "invalid", {"timestamp": "2025-08-10T10:30:00Z", "confidence": 0.85, "duration": 2.3, "description": "Test"}),
        (MotionEvent, "timestamp", 123456, {"id": 1, "confidence": 0.85, "duration": 2.3, "description": "Test"}),
    ])
    ...
    @pytest.mark.parametrize("confidence,duration", [
        (0.0, 0.0),              # Zero values
...
class TestMotionSettingsModel:
    ...
    @pytest.mark.parametrize("boolean_field", [
    ...
    @pytest.mark.parametrize("sensitivity,min_confidence", [
        (0.0, 0.0),      # Zero values
...
class TestLLaVAModels:
    ...
    def test_llava_request_default_prompt(self, image_data):
        ...
        assert request.prompt == "Describe what you see in this image"

    @pytest.mark.parametrize("success,description,error_message", [
    ...
    def test_llava_model_type_validation(self, field, invalid_value):
        ...
        base_response_data = {
            "description": "test", "processing_time": 1.0, 
            "model_used": "llava:latest", "success": True
        }
    ...
    @pytest.mark.parametrize("processing_time", [

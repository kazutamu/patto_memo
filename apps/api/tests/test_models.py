...
class TestLLaVAModels:
    ...
    def test_llava_request_default_prompt(self, image_data):
        ...
        assert (
            request.prompt
            == "Analyze this image and describe specifically what the person is doing. Focus on their actions, posture, and activities. If multiple people are present, describe each person's activity. Be specific about movements, gestures, or tasks being performed."
        )

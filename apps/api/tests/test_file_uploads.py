...
class TestFileUploadValidation:
    ...
    @pytest.mark.parametrize("size_mb,expected_behavior", [
        ...
        for scenario_name, mock_setup in test_scenarios:
            ...
            with TestClient(app) as client:
                ...
                if scenario_name == "server_error":
                    ...
                    assert "error" in data["error_message"].lower() or "connection" in data["error_message"].lower()
...
class TestFileUploadSecurityAndEdgeCases:
    ...
    @pytest.mark.parametrize("security_scenario,test_data", [
        ("malicious_filename", {
            "filename": "../../../etc/passwd", 
    ...
    @pytest.mark.parametrize("upload_scenario", [
        "concurrent_uploads",
        "rapid_sequential_uploads"
    ])
    def test_upload_performance_scenarios(self, upload_scenario):
        ...
        def upload_file(file_id):
            ...
            with TestClient(app) as client:
                return client.post(
                    "/api/v1/llava/analyze-upload",
                    files={"file": (f"test_{file_id}.jpg", BytesIO(data), "image/jpeg")}
                )

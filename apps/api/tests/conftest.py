...
@pytest.fixture(
    params=[
        ...
        (
            {"confidence": 1.0, "duration": 999.99, "description": "Large values"},
            "large",
        ),
        (
            {"confidence": -0.1, "duration": -1.0, "description": "Negative values"},
            "negative",
        ),
        (
            {"confidence": 0.999999, "duration": 1.0, "description": "High precision"},
            "precision",
        ),
    ]
)

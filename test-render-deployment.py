...
def test_api(base_url):
    ...
    # Test SSE endpoint (just connection info, not streaming)
    try:
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python test-render-deployment.py <base_url>")
        print("Example: python test-render-deployment.py https://your-app.onrender.com")
        sys.exit(1)
